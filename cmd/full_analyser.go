...
//	RunAnalyser(a, ProjectPath, FileName, Id, BenchName, TestName, Flags, Count, Output, Accept, Threshold)
//}
//
//func RunAnalyser(a *analysis.Analyzer, ProjectPath, FileName, Id, BenchName, TestName, Flags string, Count int, Output string, Accept string, Threshold float32) {
...
//	result := util.RunCode(Flags, BenchName, "NONE", Id, tmpPath+FileName, tmpPath, true, Count)
//	if result == "FAILED" {
...
//		}
//
//		if runTestAndBenchmark(tmpPath, Flags, TestName, BenchName, Id, FileName, Count) {
...
//	err = os.MkdirAll(Output+p+Id+p, os.ModePerm)
//	if err != nil {
