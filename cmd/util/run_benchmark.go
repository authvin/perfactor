...
func RunCode(flags string, benchName string, testName string, id string, filename string, folderPath string, doProfile bool) string {
	...
	if runtime.GOOS == "windows" {
		return runCodeWindows(flags, benchName, id, filename, folderPath, testName)
	} else {
		return runCodeLinux(flags, benchName, folderPath, testName, doProfile)
	}
}

func runCodeLinux(flags string, benchName string, folderPath string, testName string, doProfile bool) string {
...
func runCodeWindows(flags string, benchName string, id string, inputPath string, outputPath string, testName string) string {
